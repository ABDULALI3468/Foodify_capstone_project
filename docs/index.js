...
eval("/* (ignored) */\n\n//# sourceURL=webpack://foodify_capstone_project/fs_(ignored)?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"likeCreator\": () => (/* binding */ likeCreator),\n/* harmony export */   \"likeFetcher\": () => (/* binding */ likeFetcher)\n/* harmony export */ });\n/* harmony import */ var _apis_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./apis.js */ \"./src/apis.js\");\n/* harmony import */ var _elements_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements.js */ \"./src/elements.js\");\n\n\n\nconst likeFetcher = async () => {\n  const cards = (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$selectAll)('.card');\n  const likeCount = (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$selectAll)('.like-count');\n  await fetch(_apis_js__WEBPACK_IMPORTED_MODULE_0__.API_BASE_URLS.LIKES_URL)\n    .then((response) => response.json())\n    .then((json) => {\n      cards.forEach((card, index) => {\n        json.forEach((item) => {\n          if (item.item_id === card.id) {\n            (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$html)(likeCount[index], item.likes);\n          }\n        });\n      });\n    });\n};\n\nconst likeCreator = async () => {\n  const heartIcon = (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$selectAll)('.fa-heart');\n  heartIcon.forEach((elem) => {\n    elem.addEventListener('click', ({target}) => {\n      target.classList.remove('fa-regular');\n      target.classList.add('fa-solid');\n      const text = (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$html)(target.nextSibling);\n      (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$html)(target.nextSibling, Number(text) + 1);\n      (0,_apis_js__WEBPACK_IMPORTED_MODULE_0__.postData)(_apis_js__WEBPACK_IMPORTED_MODULE_0__.API_BASE_URLS.LIKES_URL, { item_id: (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$getAttrib)(target, 'target_id') });\n    });\n  });\n};\n\n\n//# sourceURL=webpack://foodify_capstone_project/./src/likes.js?");
